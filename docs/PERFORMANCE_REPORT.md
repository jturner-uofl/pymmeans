...
Timings on the developer's machine. Numbers are wall-clock seconds for the EMM/pairs operation only (model fit excluded). pymmeans 0.1.3; R 4.6, emmeans 2.0.3.

| Scenario | R emmeans | pymmeans | Speedup |
|---|---|---|---|
| scaling_n1000 | 0.023 s | 0.002 s | 13.7x |
| scaling_n10000 | 0.015 s | 0.002 s | 8.1x |
| scaling_n100000 | 0.045 s | 0.006 s | 8.1x |
| scaling_n500000 | 0.178 s | 0.023 s | 7.6x |
