...
Timings on the developer's machine. Numbers are wall-clock seconds for the EMM/pairs operation only (model fit excluded). pymmeans 0.1.6; R 4.6, emmeans 2.0.3.
