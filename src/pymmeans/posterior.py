...
class PosteriorInfo:
    ...
    () because it would replace percentile credible intervals
    with Wald intervals.
    """
...
def posterior_emmeans(
    ...
    if type == "response" and info.family is None:
        ...
        if tran is not None:
            # Accept Transform instance OR the dict-form ()
...
def from_pymc(
    ...
    """
    try:
        import arviz  # noqa: F401 # availability check; not used by name
